...
|**key** `{type}`                                                       |description                                                                                                                                                                                                                                                                          |row       |button    |link      |img       |radio     |checkbox  |select    |text      |
|-----------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|----------|----------|----------|----------|----------|----------|----------|
...
|**value** <br> `{number\|string}`                                      |The `value` attribute of the generated HTML tag, `**All object units can be used starting with version 1.4.1**`                                                                                                                                                                          |❌       |✅        |❌        |❌       |❌        |❌        |❌       |❌        |
